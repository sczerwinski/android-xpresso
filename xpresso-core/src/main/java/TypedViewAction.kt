...
/**
 * Custom interaction on a given View element of type [V].
 *
 ...
 */
class TypedViewAction<out V : View>(
    ...
    override fun getConstraints(): Matcher<View> =
        ViewMatchers.isAssignableFrom(viewType)

    override fun perform(uiController: UiController?, view: View?) {
        view?.let { viewType.cast(it) }?.action()
    }
